...
class Map extends Field
{
    ...
    protected Closure|string|null $afterInitJs = null;
    ...
    /**
     * Custom JavaScript to execute after the map is initialized.
     * Useful for adding custom map behaviors or restrictions.
     *
     * @return $this
     */
    public function afterInitJs(Closure|string|null $afterInitJs = null): static
    {
        $this->afterInitJs = $afterInitJs;

        return $this;
    }

    public function getAfterInitJs(): ?string
    {
        return $this->evaluate($this->afterInitJs);
    }
